...
%%% ---------------------------------------------------------------- %%%
        ...
        function SetVisionScope(obj)
            ...
            % Test Objects
            obj.Vision_Size = size(obj.Vision)/2;
            % Test Obj1
            obj.Vision(obj.Vision_Size(1)+2:obj.Vision_Size(1)+4,obj.Vision_Size(2)+2:obj.Vision_Size(2)+3) = 0;
            % Test obj2
            obj.Vision((end - (obj.Vision_Size(1)+4)):(end-(obj.Vision_Size(1)+2)),...
                (end - (obj.Vision_Size(2)+5)):(end - (obj.Vision_Size(2)+3))) = 0;
...
%%% ---------------------------------------------------------------- %%%
        ...
        function PathTF(obj)
            ...
            for i = 1:length(cell2mat(obj.Init_Path))/2
                obj.Init_Path{i} = obj.Init_Path{end-i+1} - obj.Init_Path{1};
            end
            disp(obj.Init_Path);
