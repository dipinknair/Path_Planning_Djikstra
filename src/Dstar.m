function [path, route] = Dstar(input_map, start_coords, dest_coords, visualization) %visualization either true or false
...
if visualization
    ...
    drawnow;                        % Update figure                % To see how nodes expand on the grid
end
...
[x, y] = ind2sub(size(distanceFromStart), route);
path = [x',y'];
